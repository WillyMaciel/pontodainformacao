...
class HomeController extends BaseController {
	...
	*/
	...
	public function postContatoLojista()
	{
		if(Input::has("mensagem"))
		{
			$user = User::find(Input::get('lojista'));
			
			$messageData = array(
	        'nome' => Input::get('email'),
	        'email' => Input::get('email'),
	        'msg' => Input::get('mensagem'),
	        'emailto' => $user->email
	    	);
	        ...
	        $message->from("contato@pontodainformacao.com.br", "ADM");
	        $message->bcc("contato@pontodainformacao.com.br", "ADM");
	        $message->to($messageData['emailto'],'Ponto da Informacao')->subject('Ponto da Informação - Você recebeu uma mensagem.');
	    	});
		}
