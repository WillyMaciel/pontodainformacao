                ...
                <div class="tab-pane active" id="tab8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body mail">
                            ...
                            <div class="col-md-6">
                                <table class="table">
                                    ...
                                    <?php $created_at = new Carbon($m->created_at); ?>
                                        <tr class="@if(!$m->visualizado) warning @endif loadmsg" data-id="{{$m->id}}"  style="cursor: pointer;">
                            ...
                            <div class="col-md-6" id="loadMsg">

                                @if(Auth::user()->perfil == 1)
                                <form method="POST" action="{{URL::to('msg-geral')}}">
                                    
                                        <h3> Mensagem Geral: </h3>

                                        <textarea name="msg_geral" class="form-control"></textarea>
...
<script type="text/javascript">
    $('.loadmsg').click(function()
    {
        ...
        $.get( '{{URL::to("mensagens/")}}/'+id, function( data ) {
          $( "#loadMsg" ).html( data );
        });
    });
