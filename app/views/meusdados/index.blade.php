                        ...
                        <p>
                            <div class="row">
                                ...
                                <div class="col-md-9">                                   
                                    ...
                                    @if($user->data_vencimento && !empty($user->pacote_id))
                                    <?php
                    ...
                    <div class="tab-pane" id="tab9">
                        ...
                        <p>
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    @if(!$user->pacote)
                                        <span class="label label-danger label-form">Você pode utilizar 20 TAGS - Pacote Grátis</span><br/><br/>

                                        <h3>Digite nos campos abaixo o nome dos produtos e/ou serviços.</h3>

                                        <span class="label label-info label-form"> Ex: notebook, fonte de notebook, bateria... </span>

                                        <div class="row" style="background-color: darkturquoise; padding-top: 4px;, margin-top: 4px;">
                                            @for($i = 0; $i <= 19; $i++)
                                               ...
                                               <div class="row" style="margin-bottom: 4px;">
                                                   ...
                                                   <div class="col-md-10">
                                                        <input name="tags_free[{{$i}}]" type="text"  class="form-control" value="{{$tags_array[$i] or ''}}" placeholder="" />
                                                   </div>
                                                </div>
                ...
                <div class="modal-body">
                    @if(!$pacotes->isEmpty())
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control select" id="pacote" name="pacote" REQUIRED>
